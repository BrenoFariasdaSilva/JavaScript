// Usage: Run this script in the browser console on the Steam Account Licenses page to get the AppIDs of all the packages that can be removed (demos, trailers, free games, trials, etc).
